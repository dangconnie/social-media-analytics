# textblob is not available in Python 3.4.2 (the version I have on Spyder). I ran this script in the command line since i have Python 2.7 on my computer. I still got my Excel file!
...
csvFile = open('govt_shutdown_results.csv','w')
